...
public class MySQLRaavareBatchDAO implements RaavareBatchDAO {
	...
	public RaavareBatchDTO getRaavareBatch(int rbId) throws DALException {
		...
		try {
			if (!rs.first())
				throw new DALException("Raavarebatch med rbId " + rbId + " findes ikke");
	...
	public void createRaavareBatch(RaavareBatchDTO raavarebatch) throws DALException {
		Connector.doUpdate("INSERT INTO raavarebatch(rb_id, raavare_id, maengde) VALUES " + "(" + raavarebatch.getRbId()
	...
	public void updateRaavareBatch(RaavareBatchDTO raavarebatch) throws DALException {
		Connector.doUpdate("UPDATE operatoer SET  pb_id = " + raavarebatch.getRbId() + ", raavare_id =  "
				+ raavarebatch.getRaavareId() + ", maengde = " + raavarebatch.getMaengde() + "' WHERE rb_id = "
