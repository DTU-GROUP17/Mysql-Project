...
public class MySQLProduktBatchKompDAO implements ProduktBatchKompDAO {
	...
	public ProduktBatchKompDTO getProduktBatchKomp(int pbId, int rbId) throws DALException {
		ResultSet rs = Connector
				.doQuery("select * from produktbatchkomponent where pb_id = " + pbId + " and rb_id = " + rbId);
		try {
			if (!rs.first())
	...
	public void updateProduktBatchKomp(ProduktBatchKompDTO produktbatchkomponent) throws DALException {
		Connector.doUpdate("UPDATE produktbatchkomponent SET tara = '" + produktbatchkomponent.getTara()
				+ "', netto =  '" + produktbatchkomponent.getNetto() + "', opr_id = '"
				+ produktbatchkomponent.getOprId() + "' WHERE (pb_id = " + produktbatchkomponent.getPbId()
