...
public class MySQLRaavareDAO implements RaavareDAO {
	...
	public RaavareDTO getRaavare(int raavareId) throws DALException {
		...
		try {
			if (!rs.first())
				throw new DALException("Raavare med raavareId " + raavareId + " findes ikke");
	...
	public void updateRaavare(RaavareDTO raavare) throws DALException {
		Connector.doUpdate("UPDATE operatoer SET  raavare_id = " + raavare.getRaavareId() + ", raavare_navn =  '"
				+ raavare.getRaavareNavn() + "', leverandoer = " + raavare.getLeverandoer() + "' WHERE raavare_id = "
